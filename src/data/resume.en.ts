...
export const resumeEn = {
  ...
  experience: [
    ...
    },
    {
      ...
      logo: 'public/swiss_army_logo.svg',
  ...
  projects: [
    {
      ...
      image: 'public/yallo_preview.jpg',
      stack: ['Python', 'FastAPI', 'RabbitMQ', 'AWS', 'Google Cloud', 'Kubernetes', 'MongoDB'],
    },
  ] satisfies Project[],
